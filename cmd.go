...
func handlePrint(cmdArgs *settings.Arguments, alpmHandle *alpm.Handle) (err error) {
	...
	case cmdArgs.ExistsArg("u", "upgrades"):
		err = printUpdateList(cmdArgs, alpmHandle, false)
	...
	case cmdArgs.ExistsArg("p", "pkgbuild"):
		err = printPkgbuilds(cmdArgs.Targets, alpmHandle)
	default:
		err = nil
	}
	return err
...
func displayFuzzyMenu(pkgS []string, alpmHandle *alpm.Handle, cmdArgs *settings.Arguments) (err error) {
	...
	return install(arguments, alpmHandle, false)
}
